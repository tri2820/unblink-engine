...
//             "moments": [
//                 {
//                     "from_time": "2024-03-18T18:01:15.000Z",
//                     "to_time": "2024-03-18T18:05:20.000Z",
...
//         - 'from_time' and 'to_time' these should be different timestamps indicating the start and end of each moment. Each moment lasts for a duration covering multiple scenes.
//         - The 'importance_score' must be a floating-point number between 0.0 (mundane) and 1.0 (critical). For normal, non interesting moments, use scores closer to 0.0 (e.g. 0.1). For significant events (e.g., emergencies or someone appeared), use scores closer to 1.0 (e.g. 0.8). Do not use mid-range scores like 0.4, 0.5, 0.6.
...
//         - "what_new": If nothing new happened in this moment, just write "nothing new". This is for capturing people or objects that appears or disappears.
//         - "what_old": Mundane background objects (e.g., furniture, appliances, structures). Not important.`
